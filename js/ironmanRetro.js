...
function retro(){
    if(retroOn){
        ...
        retroOn = false;
        //if retroOn is true, remove the retro stylesheet from the head, remove the firstElementChild of title, and set retroOn to false
    }
    else{
        ...
        retroOn = true;
        //if retroOn is false, add the retro stylesheet to the head, remove the firstElementChild of title, and set retroOn to true
    }
